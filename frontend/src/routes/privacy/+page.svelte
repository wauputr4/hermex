...
<main>
  ...
  <article>
    ...
    <div class="policy">
      ...
      <section><span>05</span><div><h2>Analitik</h2><p>Versi hosted Hermex Fun memakai Google Analytics untuk melihat cara orang memakai halaman. Instalasi lokal dan self-hosted dapat menghapus tag ini dari <code>frontend/src/app.html</code> jika tidak ingin mengirim data penggunaan.</p></div></section>
