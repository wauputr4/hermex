...
<main>
  ...
  <article>
    ...
    <div class="policy">
      ...
      <section><span>05</span><div><h2>Analitik</h2><p>Versi hosted Hermex Fun memakai Google Analytics untuk melihat cara orang memakai halaman. Tag hanya aktif jika measurement ID diisi dan halaman dibuka di hermex.fun; instalasi lokal dan self-hosted dapat mengosongkan ID tersebut.</p></div></section>
