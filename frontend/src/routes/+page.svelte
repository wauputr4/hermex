<script lang="ts">
  ...
  const t = {
    id: {
      badge: 'Hermex Fun', title: 'Hermex Fun',
      subtitle: 'Hermex Fun adalah game astrology open-source untuk belajar natal chart, menyimpan history guest, dan membaca refleksi diri lewat Hermes AI.',
